...
class SheetMusic(models.Model):
    ...
    pdf = models.FileField(validators=[validate_pdf_extension], null=True, blank=True)
    playable = models.FileField(validators=[validate_audio_extension], null=True, blank=True)
